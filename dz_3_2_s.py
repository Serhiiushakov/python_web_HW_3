...
# Перевірка роботи та вимірювання часу виконання синхронної версії
start_time = time.time()
a, b, c, d = factorize(128, 255, 99999, 10651060)
end_time = time.time()

print(f"Синхронна версія виконана за {end_time - start_time:.4f} секунд")
print(a)
print(b)
print(c)
print(d)
...
# РЕЗУЛЬТАТ:
# Синхронна версія виконана за 1.8353 секунд
